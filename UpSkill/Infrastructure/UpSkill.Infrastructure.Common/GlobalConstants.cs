namespace UpSkill.Infrastructure.Common
{
    public class GlobalConstants
    {
        ...
        public const string resetPassMessage = "<h1>Reset your password</h1><p> You told us you forgot your password. If you really did, click here to choose a new one:</p><p><a href='{0}' >Click here to reset</a></p><p>If you didn't request this email message, please ignore it!</p>";
